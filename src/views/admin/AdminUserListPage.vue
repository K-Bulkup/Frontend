<template>
  <div class="admin-user-list-page p-4">
    <h1 class="mb-4 text-2xl font-bold">사용자 목록</h1>
      ...
      <ul v-else class="divide-y divide-gray-200">
        ...
        >
          <div class="text-black">
            ...
            <p v-if="user.createdAt" class="text-xs text-black">
              생성일: {{ new Date(user.createdAt).toLocaleString() }}
            </p>
            <p v-if="user.updatedAt" class="text-xs text-black">
          ...
          <div class="flex space-x-2">
            <BaseButton
              ...
              "
              class="rounded-md bg-black py-1 text-sm font-bold text-white hover:bg-gray-800"
              >수정</BaseButton
            >
            <BaseButton
